...
ax1.axvline(0.5*np.pi, color="k", linestyle="--", linewidth = 0.8)
ax1.axhline(-2,color="k", linestyle="--", linewidth = 0.8)
ax1.plot(np.arctan(t/lambda_R),-2, "ob", markersize=2)
...
ax1.set_ylabel(r"$\epsilon(k_x)\mp 2\lambda\sin k_x$", labelpad=0)
