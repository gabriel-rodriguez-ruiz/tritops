...
for k in k:
    effective = ax3.plot(phi, [1.25*effective_current(k, phi, theta, t_J=t_J, lambda_R=lambda_R,
                                                      ...
                                                      rho_k=parameters(k, lambda_R, Delta_0, Delta_1, mu, t)[1]) for phi in phi_values],
...
ax3.plot(phi, [1.25*effective_current(-np.pi, phi, theta, t_J=t_J, lambda_R=lambda_R,
                                      ...
                                      rho_k=parameters(-np.pi, lambda_R, Delta_0, Delta_1, mu, t)[1]) for phi in phi_values],
...
ax3.set_ylabel(r"$J_k(\phi)[e/\hbar]$", labelpad=0)
